...
<div id="main_container">
  ...
  <div id="main_content">
    ...
    <div class="center_content">
      <div class="center_title_bar">Confirm Order</div>
	 <?php
	...
	<form name="buyform" method="post" action="../Backend/buy.php">
	...
	<td><table border="0" style="background-color:#F1F0F0; margin-top:0px ; width:200px; border:0px solid #999999; border-radius:5px; height:300px;"    align="center">
            ...
            <tr>
			<td style="color:#0099FF; font-size:23px;" colspan="2" align="center"><b>Place Your Order</b></td>
			</tr>
            ...
            <tr>
			<td align="center" colspan="2"><input type="hidden" name="buy" value="ok"/><input type="submit" name="buynn" value="Buy" style="border:0px solid #000000; border-radius:5px; background-color:#269FB2; height:25px; color:#FFFFFF;"></td>
			</tr>
    ...
    <div class="right_content">
      <div class="shopping_cart">
        ...
        <tr>
		<td><b>Price</b></td><td><?php $_SESSION['productPrice']= $info['pprice']; echo $info['pprice'];?></td>
		</tr>
		...
		<td><b>Image</b></td><td></td>
		 ...
		 <div class="clear"> </div>
		<tr>
		<td> <div class="order_icon"><a href="order.php"><img src="images/order-now.png" alt="" /></a></div></td>
		</tr>
		</table>
      </div>
	<?php 
