...
elseif ($ProductCategory == 'low'){
$query ="SELECT * FROM product WHERE pprice BETWEEN '0' AND '1000';";
}
elseif ($ProductCategory == 'medium'){
$query ="SELECT * FROM product WHERE pprice BETWEEN '1000' AND '10000';";
}
elseif ($ProductCategory == 'high'){
$query ="SELECT * FROM product WHERE pprice BETWEEN '10000' AND '100000';";
}
else
{
$query ="SELECT * FROM product WHERE pcat='$ProductCategory' or pmfg='$ProductCategory'";
}
...
?>  
      ...
      <div class="prod_box">
        ...
        <div class="center_prod_box">
          <div class="product_title"><a href="pdetails.php?pid=<?php echo $info['pid']?>"><?php echo $info['pname']?></a></div>
          <div class="product_img"><img src="../Backend/uploads/<?php echo $info['pimg1']?>" alt="img" border="0" /></div>
          <div class="prod_price"> <span class="price">&#8377; <?php echo $info['pprice']?></span></div>
        </div>
        <div class="bottom_prod_box"></div>
        <div class="prod_details_tab"> <a href="pdetails.php?pid=<?php echo $info['pid']?>" class="prod_details">details</a> </div>
      </div>
<?php 
  }
...
?>  
    ...
    <div class="right_content">
      <div class="shopping_cart">
		...
		<tr>
		<td><b>Manufacturer</b></td><td></td>
		</tr>
		<tr>
		<td><b>Stock</b></td><td></td>
		</tr>
		<tr>
		<td><b>Image</b></td><td></td>
		 ...
		 <div class="clear"> </div>
		<tr>
		<td> <div class="order_icon"><a href="#"><img src="images/order-now.png" alt="" /></a></div></td>
		</tr>
		</table>
      </div>
